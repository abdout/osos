...
import { SendIcon, TrackIcon, PriceIcon, TimeIcon, ContactIcon, VoiceIcon } from './icons';
                  ...
                  <div className="flex-1 flex flex-col items-center justify-center">
                    ...
                    <div className="grid grid-cols-2 gap-2 w-full px-2 max-w-sm">
                      <Button
                        variant="secondary"
                        size="sm"
                        onClick={() => onSendMessage(dictionary.quickActions.trackQuestion)}
                        className="text-xs h-auto py-2.5 px-3 flex items-center gap-2 bg-muted hover:bg-muted/80 border-0"
                      >
                        <TrackIcon size={16} />
                        <span>{dictionary.quickActions.track}</span>
                      </Button>
                      <Button
                        variant="secondary"
                        size="sm"
                        onClick={() => onSendMessage(dictionary.quickActions.ratesQuestion)}
                        className="text-xs h-auto py-2.5 px-3 flex items-center gap-2 bg-muted hover:bg-muted/80 border-0"
                      >
                        <PriceIcon size={16} />
                        <span>{dictionary.quickActions.rates}</span>
                      </Button>
                      <Button
                        variant="secondary"
                        size="sm"
                        onClick={() => onSendMessage(dictionary.quickActions.deliveryQuestion)}
                        className="text-xs h-auto py-2.5 px-3 flex items-center gap-2 bg-muted hover:bg-muted/80 border-0"
                      >
                        <TimeIcon size={16} />
                        <span>{dictionary.quickActions.delivery}</span>
                      </Button>
                      <Button
                        variant="secondary"
                        size="sm"
                        onClick={() => onSendMessage(dictionary.quickActions.contactQuestion)}
                        className="text-xs h-auto py-2.5 px-3 flex items-center gap-2 bg-muted hover:bg-muted/80 border-0"
                      >
                        <ContactIcon size={16} />
                        <span>{dictionary.quickActions.contact}</span>
                      </Button>
                    </div>
                  </div>
                ) : (
